...
class DigitalLibraryManagement{
    ...
    public void admin_login()
    {
        ...
        loginto.put("Prabhas",13579);
        loginto.put("Maddila",20026);
    ...
    public void user_login()
    {
        ...
        System.out.print("Enter Password: ");
        int password = sc.nextInt();
        loginto.put("John",13579);
        loginto.put("David",20026);
        loginto.put("Tom",12345);
        loginto.put("Jack",24680);
        loginto.put("Henry",11111);
